...
public class Application9 {
    public static void main(String[] args) {
        ...
        * */
        ...
        int minNumber = cal.minNumberOf(first, second);
        System.out.println("두 수 중 최소값은? " + minNumber);

        /* static 메소드인 경우 */
        /* 다른 클래스에 작성한 static 메소드의 경우 호출할 때 클래스명을 반드시 기술해야한다.
        * 클래스명.메소드명();
        * */
        int maxNumber = Calculator.maxNumberOf(first, second);
        System.out.println("두 수 중 최대값은? " + maxNumber);
        /*
        * static 메소드는 non-static메소드처럼 호출은 가능하지만 권장하지 않는다
