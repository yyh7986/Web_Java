...
public class Application {
    public static void main(String[] args) {
        ...
        *    자식 클래스에 모두 영향을 줄 수 있다. 역시 유지보수에 악역향을 미친다.
        * 3. 부모클래스에서는 의미있었던 기능들이 자식 클래스에서는 무의미할 수 있다.(불필요한 기능이 추가됨)
        * */

        /*
        * 장점과 단점을 고려했을 때 상송은 재사용이라는 장점만을 바라보게 되면 오용의 가능성이 있기 때문에 유지보수에
        ...
        * */
        ...
        /*
        * 적절한 첵임을 수행하는 객체 또한 그 객체만 수행할 수 있는 기능이라기 보다 역할의 관점으로 바라봐야한다.
